...
class ApplicationState {
  ...
  getNavItems() {
    return [
      ...
      {
        icon: `<svg width="20" height="20" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  getFinanceItems() {
    return [
      ...
      {
        icon: `<svg width="20" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
document.querySelectorAll('.date-picker').forEach((picker, index) => {
  ...
  const flatpickrInstance = flatpickr(input, {
    ...
    altInput: true,
    altFormat: 'd.m.Y',
    locale: flatpickr.l10ns.ru, // <-- Rus tiliga o‘tkazish
    defaultHour: 0,
    defaultMinute: 0,
    rangeSeparator: ' — ',
    ...
    onDayCreate: (dObj, dStr, fp, dayElem) => {
      ...
      // Optional: siz boshqa ranglar yoki border ham qo‘shishingiz mumkin
    }
  });
