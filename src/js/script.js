// // Navigation data with updated icons and proper structure
// const navItems = [
//   {
...
//     if (this.openSubmenu && this.openSubmenu.type === menuType && this.openSubmenu.index === index) {
//       this.openSubmenu = null;
//     } else {
...
//     // Update main content based on path
//     const mainContentTitle = document.querySelector('main h1');
//     if (mainContentTitle) {
//       mainContentTitle.textContent = `Page: ${path}`;
//     }
//   }
...
//       notificationClose, userDropdownToggle, notificationDropdown, userDropdown
//     } = this.elements;
...
//   module.exports = { DashboardState, navItems, financeItems, supportItems };
// }


// // Complete JavaScript implementation for the dashboard application
